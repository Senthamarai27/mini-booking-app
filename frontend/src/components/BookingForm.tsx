...
const BookingForm: React.FC = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <input placeholder="Name" style={{marginRight:"10px", marginLeft:"10px"}} value={name} onChange={e => setName(e.target.value)} required />
      <input placeholder="Email" style={{marginRight:"10px"}} type="email" value={email} onChange={e => setEmail(e.target.value)} required />
      <input placeholder="Slot" style={{marginRight:"10px"}} value={slot} onChange={e => setSlot(e.target.value)} required />
